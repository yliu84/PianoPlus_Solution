...
(
	...
	INT IDENTITY(2000,1)
	NOT NULL
	CONSTRAINT PK_Instrutor_InstructorID PRIMARY KEY,
...
(
	...
	NVARCHAR(6)
	NOT NULL
	CONSTRAINT PK_Course_CourseCode PRIMARY KEY,
...
(
	...
	INT IDENTITY(1,1)
	NOT NULL
	CONSTRAINT PK_Post_PostID PRIMARY KEY,
...
(
	...
	INT IDENTITY(1,1)
	NOT NULL
	CONSTRAINT PK_Announcement_AnnouncementID PRIMARY KEY,
