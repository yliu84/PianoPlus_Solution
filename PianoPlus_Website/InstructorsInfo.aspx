...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container">
        ...
        <div class="row" data-sr='wait 0.1s, then enter left and hustle 55px over 1.5s' style="margin-top: 20px">           
            <div class="col-md-4">
                <img src="Images/works/24.png" alt="instructor pic" width="100%" style="margin-top: 25px" />
            </div>
            <div class="col-md-4">
                <img src="Images/works/25.jpg" alt="instructor pic" width="100%" style="margin-top: 25px" />
            </div>
            <div class="col-md-4">
                <img src="Images/works/26.jpg" alt="instructor pic" width="100%" style="margin-top: 25px" />
            </div>
        </div>
        <div class="row" data-sr='wait 0.1s, then enter left and hustle 55px over 1.5s' style="margin-top: 20px">           
            <div class="col-md-4">
                <img src="Images/works/27.jpg" alt="instructor pic" width="100%" style="margin-top: 25px" />
            </div>
            <div class="col-md-4">
