...
public partial class UserControls_MessageUserControl : System.Web.UI.UserControl
{
    ...
    {
        ShowInfo(STR_TITLE_UsageInstructions, message, "info");
    }
    /// <summary>
    ...
    /// <param name="message">Text to display as the message</param>
    public void ShowInfo(string title, string message, string type)
    {
        if (type == "success")
        {
            ShowInfo(message, title, STR_TITLE_ICON_success, STR_PANEL_success);
        }
        if (type == "info")
        {
        ...
        if (type == "danger")
        {
            ShowInfo(message, title, STR_TITLE_ICON_warning, STR_PANEL_danger);
        }
    }
    /// <summary>
